...
/datum/round_event/supermatter_surge/announce(fake)
	...
	priority_announce("Системы мониторинга кристалла Супер Материи заметили значительные отклонения энергетического потока. Это не учебная тревога", "Предупреждение о расслоении суперматерии, класс тревоги [class_to_announce], ", 'sound/machines/engine_alert/engine_alert3.ogg')
...
/datum/round_event/supermatter_surge/end()
	...
	priority_announce("Расслоение приостановлено, показатели Суперматерии пришли в норму. Хорошая работа.", "Аномалия устранена")
	engine = null
	sm_gas = null
...
/datum/round_event/supermatter_surge/poly/announce(fake)
	priority_announce("Система мониторинга целостности кристалла зафиксировала попугайный резонанс в камере Суперматерии, выход энергии из кристалла значительно возрос. Требуется вмешательство инженеров.", "Предупреждение о расслоении Суперматерии класса П", 'sound/machines/engine_alert/engine_alert3.ogg')
