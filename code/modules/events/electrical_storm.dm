...
/datum/round_event/electrical_storm/announce(fake)
	priority_announce("В вашем районе зафиксирована электромагнитная аномалия. Просим принять меры по предотвращению возможных перегрузок электрооборудования.", "Предупреждение об электромагнитной буре")
