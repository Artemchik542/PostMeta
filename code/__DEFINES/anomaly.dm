...
#define ANOMALY_ANNOUNCE_MEDIUM_TEXT "обнаруженно сканерами дальнего действия. Объект находится в:"
...
///Let them know how far away the anomaly is
#define ANOMALY_ANNOUNCE_HARMFUL_TEXT "обнаруженно сканерами. Объект находится в:"
...
///Let them know how far away the anomaly is
#define ANOMALY_ANNOUNCE_DANGEROUS_TEXT "обнаруженно сканерами. Объект находится в:"
